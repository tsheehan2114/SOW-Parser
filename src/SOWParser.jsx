...
const SKUS = [
  { name: "Market Size Report & Competitive Analysis", code: "MKT-LCH-MSRCA", feeType: "One-Time", revRec: "Milestone", owner: "David C", primaryGroup: "Marketing", startLogic: "Billing Date", endLogic: "Billing Date + 3 Months" },
  ...
  { name: "Marketing & Enrollment Analysis & Planning", code: "MKT-ANN-MAP", feeType: "Annual", revRec: "Straight Line", owner: "", primaryGroup: "Marketing", startLogic: "Billing Date", endLogic: "SOW End Date" },
  ...
  { name: "Search + Content Optimization", code: "MKT-ANN-SEO", feeType: "Annual", revRec: "Straight Line", owner: "", primaryGroup: "Marketing", startLogic: "Billing Date", endLogic: "SOW End Date" },
  ...
  { name: "Essentials+ Course Builds", code: "LD-LCH-ESS+", feeType: "One-Time", revRec: "Milestone", owner: "Saskia", primaryGroup: "Learning Design", startLogic: "Billing Date", endLogic: "SOW End Date" },
  { name: "Premium Course Builds", code: "LD-LCH-PREM", feeType: "One-Time", revRec: "Milestone", owner: "Saskia", primaryGroup: "Learning Design", startLogic: "Billing Date", endLogic: "SOW End Date" },
  ...
  { name: "Essential Refresh", code: "LD-LCH-EREF", feeType: "One-Time", revRec: "Milestone", owner: "Saskia", primaryGroup: "Learning Design", startLogic: "Billing Date", endLogic: "SOW End Date" },
  { name: "Essential+ Refresh", code: "LD-LCH-E+REF", feeType: "One-Time", revRec: "Milestone", owner: "Saskia", primaryGroup: "Learning Design", startLogic: "Billing Date", endLogic: "SOW End Date" },
  { name: "Premium Refresh", code: "LD-LCH-PREREF", feeType: "One-Time", revRec: "Milestone", owner: "Saskia", primaryGroup: "Learning Design", startLogic: "Billing Date", endLogic: "SOW End Date" },
  ...
  { name: "Student Support Collateral", code: "SSP-LCH-PREP", feeType: "One-Time", revRec: "Milestone", owner: "Melissa", primaryGroup: "Student Support", startLogic: "Billing Date", endLogic: "Billing Date + 3 Months" },
  { name: "Placement Level 1", code: "PLC-LCH-LVL1", feeType: "One-Time", revRec: "Straight Line", owner: "", primaryGroup: "Placement", startLogic: "Billing Date", endLogic: "SOW End Date" },
  { name: "Placement Level 2", code: "PLC-LCH-LVL2", feeType: "One-Time", revRec: "Straight Line", owner: "", primaryGroup: "Placement", startLogic: "Billing Date", endLogic: "SOW End Date" },
  { name: "Placement Level 3", code: "PLC-LCH-LVL3", feeType: "One-Time", revRec: "Straight Line", owner: "", primaryGroup: "Placement", startLogic: "Billing Date", endLogic: "SOW End Date" },
  { name: "Placement Level 4", code: "PLC-LCH-LVL4", feeType: "One-Time", revRec: "Straight Line", owner: "", primaryGroup: "Placement", startLogic: "Billing Date", endLogic: "SOW End Date" },
  { name: "Placement Level 5", code: "PLC-LCH-LVL5", feeType: "One-Time", revRec: "Straight Line", owner: "", primaryGroup: "Placement", startLogic: "Billing Date", endLogic: "SOW End Date" },
  { name: "Placement Level 6", code: "PLC-LCH-LVL6", feeType: "One-Time", revRec: "Straight Line", owner: "", primaryGroup: "Placement", startLogic: "Billing Date", endLogic: "SOW End Date" },
  { name: "Noodle Learning Platform Licensing Fee", code: "TECH-ANN-NLP-LIC", feeType: "Annual", revRec: "", owner: "", primaryGroup: "Technology", startLogic: "Billing Date", endLogic: "SOW End Date" },
  { name: "Noodle Learning Platform Discovery", code: "TECH-LCH-NLP-DISC", feeType: "One-Time", revRec: "", owner: "", primaryGroup: "Technology", startLogic: "Billing Date", endLogic: "Billing Date + 3 Months" },
  { name: "Noodle Learning Platform LMS Integration", code: "TECH-LCH-NLP-LMSINT", feeType: "One-Time", revRec: "", owner: "", primaryGroup: "Technology", startLogic: "Billing Date", endLogic: "Billing Date + 3 Months" },
  { name: "Noodle Moodle LMS", code: "TECH-ANN-NLP-MOODLE", feeType: "Annual", revRec: "", owner: "", primaryGroup: "Technology", startLogic: "Billing Date", endLogic: "SOW End Date" },
  { name: "Noodle Learning Platform CMS Integration", code: "TECH-LCH-NLP-CMSINT", feeType: "One-Time", revRec: "", owner: "", primaryGroup: "Technology", startLogic: "Billing Date", endLogic: "Billing Date + 3 Months" },
  { name: "NLP Merchant of Record", code: "TECH-ANN-NLP-MOR", feeType: "Annual", revRec: "", owner: "", primaryGroup: "Technology", startLogic: "Billing Date", endLogic: "SOW End Date" },
